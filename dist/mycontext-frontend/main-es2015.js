...
let UserService = class UserService {
    ...
    doRegistration(formItem) {
        if (formItem.usertype == "patient") {
            let newUser = { user_id: "p1234", user_type: formItem.usertype, username: formItem.username, password: formItem.password };
            ...
            let newUser = { user_id: "h1234", user_type: formItem.usertype, username: formItem.username, password: formItem.password };
            this.users.push(newUser);
            ...
            let newUser = { user_id: "b1234", user_type: formItem.usertype, username: formItem.username, password: formItem.password };
            this.users.push(newUser);
